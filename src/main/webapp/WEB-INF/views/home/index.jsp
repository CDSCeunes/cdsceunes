...
<body>
	<div class="container">
		...
		<div class="row" style="text-align: center">
			<spring:url value="/resources/img/logos-ufes.png" var="logo" />
			<img src="${logo}"> <br>
			<br>
		</div>
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-4">
					<input id="login" name="login" class="form-control"
						placeholder="login único ufes" required autofocus type="text">
					<input id="senha" name="senha" class="form-control"
						placeholder="senha única ufes" required type="password"> <br>
					<br>
		...
		<div class="row">
			<footer style="text-align: center">
				<span style="font-size: small"> &copy; CDS-Centro de
					Desenvolvimento de Software 2015 </span>
			</footer>
		</div>
	</div>
</body>
